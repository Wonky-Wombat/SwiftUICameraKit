...
public extension MCamera {
     ...
     */
    func setCameraOutputType(_ cameraOutputType: CameraOutputType) -> Self { managerForInitialization.attributes.outputType = cameraOutputType; return self }
     ...
     */
    func setCameraPosition(_ cameraPosition: CameraPosition) -> Self { managerForInitialization.attributes.cameraPosition = cameraPosition; return self }
     ...
     */
    func setAudioAvailability(_ isAvailable: Bool) -> Self { managerForInitialization.attributes.isAudioSourceAvailable = isAvailable; return self }
     ...
     */
    func setZoomFactor(_ zoomFactor: CGFloat) -> Self { managerForInitialization.attributes.zoomFactor = zoomFactor; return self }
     ...
     */
    func setFlashMode(_ flashMode: CameraFlashMode) -> Self { managerForInitialization.attributes.flashMode = flashMode; return self }
     ...
     */
    func setLightMode(_ lightMode: CameraLightMode) -> Self { managerForInitialization.attributes.lightMode = lightMode; return self }
     ...
     */
    func setResolution(_ resolution: AVCaptureSession.Preset) -> Self { managerForInitialization.attributes.resolution = resolution; return self }
     ...
     */
    func setFrameRate(_ frameRate: Int32) -> Self { managerForInitialization.attributes.frameRate = frameRate; return self }
     ...
     */
    func setCameraExposureDuration(_ duration: CMTime) -> Self { managerForInitialization.attributes.cameraExposure.duration = duration; return self }
     ...
     */
    func setCameraTargetBias(_ targetBias: Float) -> Self { managerForInitialization.attributes.cameraExposure.targetBias = targetBias; return self }
     ...
     */
    func setCameraISO(_ iso: Float) -> Self { managerForInitialization.attributes.cameraExposure.iso = iso; return self }
     ...
     */
    func setCameraExposureMode(_ exposureMode: AVCaptureDevice.ExposureMode) -> Self { managerForInitialization.attributes.cameraExposure.mode = exposureMode; return self }
     ...
     */
    func setCameraHDRMode(_ hdrMode: CameraHDRMode) -> Self { managerForInitialization.attributes.hdrMode = hdrMode; return self }
     ...
     */
    func setCameraFilters(_ filters: [CIFilter]) -> Self { managerForInitialization.attributes.cameraFilters = filters; return self }

    /**
     Changes the initial mirror output setting.
     */
    func setMirrorOutput(_ shouldMirror: Bool) -> Self { managerForInitialization.attributes.mirrorOutput = shouldMirror; return self }

    /**
     Changes the initial grid visibility setting.
     */
    func setGridVisibility(_ shouldShowGrid: Bool) -> Self { managerForInitialization.attributes.isGridVisible = shouldShowGrid; return self }

    /**
     Changes the shape of the focus indicator visible when touching anywhere on the camera screen.
     */
    func setFocusImage(_ image: UIImage) -> Self { managerForInitialization.cameraMetalView.focusIndicator.image = image; return self }

    /**
     Changes the color of the focus indicator visible when touching anywhere on the camera screen.
     */
    func setFocusImageColor(_ color: UIColor) -> Self { managerForInitialization.cameraMetalView.focusIndicator.tintColor = color; return self }

    /**
     Changes the size of the focus indicator visible when touching anywhere on the camera.
     */
    func setFocusImageSize(_ size: CGFloat) -> Self { managerForInitialization.cameraMetalView.focusIndicator.size = size; return self }
}
...
public extension MCamera {
    ...
    func setAVPhotoCaptureSettings(_ settings: @escaping () -> AVCapturePhotoSettings) -> Self {
        managerForInitialization.attributes.capturePhotoSettings = settings
        return self
    }
    
    func configureOutput(_ action: @escaping (AVCapturePhotoOutput) -> ()) -> Self {
        managerForInitialization.attributes.configureOutput = action
        return self
    }
...
public extension MCamera {
    ...
    /**
     ...
     ```
     */
    func lockCameraInPortraitOrientation(_ appDelegate: MApplicationDelegate.Type) -> Self { config.appDelegate = appDelegate; managerForInitialization.attributes.orientationLocked = true; return self }
